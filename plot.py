...
def main():
    ...
    num_plot_rows = args.full + args.zoom
...
#        return -1
    ...
    cosmo = astropy.cosmology.Flatw0waCDM(H0=69.,Om0=0.3,w0=-1.,wa=-0.0)
    ...
    for iperm,perm in enumerate(perms):
        ...
        if args.full:
            ...
            #plt.plot(1+zvalues,DH_true/DH0,'r--')
            if args.examples:
            ...
            #plt.plot(1+zvalues,DA_true/DA0,'r--')
            if args.examples:
        ...
        if args.zoom:
            ...
            plt.fill_between(zvalues[:],1e-3*DH_limits[0,:],1e-3*DH_limits[-1,:],
                facecolor='blue',alpha=0.25)
            plt.plot(zvalues[:],1e-3*DH_limits[0,:],'b:')
            plt.plot(zvalues[:],1e-3*DH_limits[1,:],'b-')
            plt.plot(zvalues[:],1e-3*DH_limits[2,:],'b:')
            plt.plot(zvalues[:],1e-3*DH0[:],'g--')
            #plt.plot(zvalues[:],1e-3*DH_true[:],'r--')
            plt.xlabel(r'$z$')
            ...
            plt.grid(True)
            plt.xlim([0.,args.zmax])
            plt.fill_between(zvalues[:],1e-3*DA_limits[0,:],1e-3*DA_limits[-1,:],
                facecolor='blue',alpha=0.25)
            plt.plot(zvalues[:],1e-3*DA_limits[0,:],'b:')
            plt.plot(zvalues[:],1e-3*DA_limits[1,:],'b-')
            plt.plot(zvalues[:],1e-3*DA_limits[2,:],'b:')
            plt.plot(zvalues[:],1e-3*DA0[:],'g--')
            #plt.plot(zvalues[:],1e-3*DA_true[:],'r--')
            plt.xlabel(r'$z$')
