...
def get_fiducial():
    ...
    #h = 0.6736
    h=0.69 # old Planck+SN+BAO +H0
    #h = 0.68893466 # best fit mock LCDM
    #h = 0.69466611 # best fit mock w0wa
    #h = 0.68226328 # best fit mock w0wa2
    #h = 0.68339726 # best fit mock w0wa2 seed 0
    print(h)
    Om = 0.3 # old Planck+SN+BAO +H0
    #Om = 0.30003094 # best fit mock LCDM
    #Om = 0.27716126 # best fit mock w0wa
    #Om = 0.29097835 # best fit mock w0wa2
    #Om = 0.29232151 # best fit mock w0wa2 seed 0
    print(Om)
    #mnu = 0.06
    #Onu0 = (mnu/93.04)/h**2
    return astropy.cosmology.FlatLambdaCDM(
        H0=100*h,Om0=Om)
        #H0=100*h,Om0=0.3153-Onu0,Tcmb0=2.7255,Neff=3.046,m_nu=(0.,0.,mnu)*unit.eV)
